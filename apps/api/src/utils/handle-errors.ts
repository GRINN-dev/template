...
export function handleSafeError(e: any, defaultMessage: string) {
  ...
  if (safeErrorCodes.includes(code)) {
    ...
    console.error("Unrecognized error; replacing with sanitized version");
    console.error(e);
    throw Object.assign(new Error(defaultMessage), { code });
  }
}
