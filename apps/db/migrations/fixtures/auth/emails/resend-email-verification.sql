 ...
 * with this function.
 */
create function publ.resend_email_verification_code(email_id uuid) returns boolean as $$
begin
  if exists(
    select 1
...
comment on function publ.resend_email_verification_code(email_id uuid) is
